...
WebUI.setEncryptedText(findTestObject('Page_Swag Labs/input_password'), '8SQVv/p9jVR0UOrKCEogRg==')
...
'Mencoba Memasukkan password yang salah'
WebUI.verifyElementText(findTestObject('Page_Swag Labs/error_message'), 'Epic sadface: Username and password do not match any user in this service')
