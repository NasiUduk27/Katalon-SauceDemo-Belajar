...
'Memberi jeda pada browser dan memberi validasi jika login tersebut sukses dengan mengarah ke halaman utama'
WebUI.waitForElementVisible(findTestObject('Page_Swag Labs/header_homscreen'), 10)
